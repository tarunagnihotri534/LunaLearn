      ...
      <div className="max-w-4xl w-full space-y-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-white border border-primary/10 rounded-3xl p-6 md:p-8 shadow-soft space-y-4 hover:scale-[1.005] transition-soft">
            ...
            <h3 className="font-fredoka text-xl font-bold text-charcoal">Starting the Conversation</h3>
          ...
          <div className="bg-white border border-primary/10 rounded-3xl p-6 md:p-8 shadow-soft space-y-4 hover:scale-[1.005] transition-soft">
            ...
            <h3 className="font-fredoka text-xl font-bold text-charcoal">Assembling a Period Kit</h3>
            <p className="text-xs md:text-sm text-warm-gray leading-relaxed font-semibold">
          ...
          <div className="bg-white border border-primary/10 rounded-3xl p-6 md:p-8 shadow-soft space-y-4 hover:scale-[1.005] transition-soft">
            ...
            <h3 className="font-fredoka text-xl font-bold text-charcoal">Nurturing Confidence</h3>
            <p className="text-xs md:text-sm text-warm-gray leading-relaxed font-semibold">
          ...
          <div className="bg-white border border-primary/10 rounded-3xl p-6 md:p-8 shadow-soft space-y-4 hover:scale-[1.005] transition-soft">
            ...
            <h3 className="font-fredoka text-xl font-bold text-charcoal">When to Consult a Doctor</h3>
            <p className="text-xs md:text-sm text-warm-gray leading-relaxed font-semibold">
        ...
        <div className="bg-bubble-pink/30 border border-primary/15 rounded-3xl p-6 shadow-soft flex items-start gap-4 hover:scale-[1.01] transition-soft bouncy-hover">
          ...
          <div className="space-y-1.5 text-left">
            <h4 className="font-fredoka text-base font-bold text-charcoal">A note on medical advice:</h4>
